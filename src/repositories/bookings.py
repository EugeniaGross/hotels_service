...
class BookingsRepository(BaseRepository):
    ...
    async def get_all(self, limit, offset, **filter_by) -> Sequence[Bookings]:
    ...
    async def get_bookings_with_today_checkin(self) -> Sequence[Bookings]:
    ...
    async def add_booking(self, data: BaseModel, hotel_id: int) -> Bookings:
